...
const settings = [
  ...
  { id: "3", name: "Dữ liệu di động", description: "Cho phép sử dụng dữ liệu di động" },
  { id: "4", name: "Tự động sao lưu", description: "Tự động sao lưu dữ liệu" },
  { id: "5", name: "Cập nhật tự động", description: "Tự động cập nhật ứng dụng" },
  { id: "6", name: "Ẩn thông tin nhạy cảm", description: "Ẩn thông tin nhạy cảm trên màn hình chính" },
  { id: "7", name: "Định vị", description: "Cho phép ứng dụng truy cập vị trí của bạn" },
];
